...
Je soutiens la déclaration [Math and AI](https://mathandai.org). J'utilise actuellement l'assistance d'outils d'IA générative pour des tâches diverses comme la construction de ce site web, mais pas encore dans la production d'articles de recherche. Si cela venait à changer, tout résultat obtenu à l'aide de ces outils sera clairement signalé. 
