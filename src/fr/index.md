...
Depuis septembre 2026, je suis postdoctorant à l'[Institut de Mathématiques](https://math.uni-koeln.de) de l'Université de Cologne dans le groupe de [George Marinescu](https://www.mi.uni-koeln.de/~gmarines/).
...
Je soutiens la déclaration [Math and AI](https://mathandai.org). J'utilise actuellement l'assistance des outils d'IA générative pour des tâches diverses, comme la construction de ce site web. Je ne les ai pas encore utilisés pour produire des articles de recherche. Si cela venait à changer, tout résultat obtenu à l'aide de ces outils sera clairement signalé. 
